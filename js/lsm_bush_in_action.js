...
function init(){
	...
	document.getElementById("cost").value = 3000;
...
function SetProvider(cloud_provider){
	reset_button_colors("cloud_provider");
	if(cloud_provider == 0){
		//document.getElementById('lsm_tree_T').value = getTieringT();
		document.getElementById('GCP').style.fontWeight = 'bold';
		document.getElementById('GCP').style.fontSize = '16px';
	}else if(cloud_provider == 1){
		document.getElementById('AWS').style.fontWeight = 'bold';
		document.getElementById('AWS').style.fontSize = '16px';
	}else{
		document.getElementById('Azure').style.fontWeight = 'bold';
		document.getElementById('Azure').style.fontSize = '16px';
	}
	re_run(event, 'input4');
}
